...
extension Device {
    ...
    static var isCompactWidth: Bool {
        return UIScreen.main.bounds.width < compactWidth
    }
    
    static let iPadPro12InchMultitaskingLargeWidth: CGFloat = 694
    
    // 10.5" iPad Pro in Multitasking Mode
    static let compactWidth: CGFloat = 505
    
    // iPhone SE & iPad Compact Multitasking Mode
    static let ultraCompactWidth: CGFloat = 320
